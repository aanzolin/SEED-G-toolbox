...
function [Y_gen, E_gen, ModelDel, flag_out]=simulatedData_generation_with_volume_conduction(DataLength,Trials,ModelDel,SNR,real_samp,sig_num,density,val_Range,AR_perc,AR_choice,popt,forward,sensors_labels,ROI_labels,nyh_path,ft_path)
...
if forward
    ...
    cd(nyh_path)
    load LF_ICBM152-NY_5004x231x3.mat;
    LF3d = LF;clear LF
